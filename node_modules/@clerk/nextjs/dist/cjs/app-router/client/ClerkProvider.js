...
Your current Next.js version (${import_package.default.version}) will be deprecated in the next major release of "@clerk/nextjs". Please upgrade to next@14.1.0 or later.`;
    if ((0, import_browser.inBrowser)()) {
      import_logger.logger.warnOnce(deprecationWarning);
    } else {
      import_logger.logger.logOnce(`
\x1B[43m----------
${deprecationWarning}
----------\x1B[0m
`);
    ...
    window.__unstable__onBeforeSetActive = () => {
      return new Promise((res) => {
        ...
        if (((_a = window.next) == null ? void 0 : _a.version) && typeof window.next.version === "string" && window.next.version.startsWith("13")) {
          ...
          void (0, import_server_actions.invalidateCacheAction)().then(() => res());
        }
      });
    };
...
const ClientClerkProvider = (props) => {
  ...
  if (safePublishableKey || !import_feature_flags.canUseKeyless__client) {
    return /* @__PURE__ */ import_react.default.createElement(NextClientClerkProvider, { ...rest }, children);
  }
  return /* @__PURE__ */ import_react.default.createElement(LazyCreateKeylessApplication, null, /* @__PURE__ */ import_react.default.createElement(NextClientClerkProvider, { ...rest }, children));
};
